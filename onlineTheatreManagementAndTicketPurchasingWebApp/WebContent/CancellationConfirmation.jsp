...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
	...
	<center>
		<h1>Your requested item in Order <c:out value="${cancelItem.aOrder.orderId}"/> has been cancelled
			successfully</h1>
		<br> The information is listed below: <br> <br>
		...
		<br> The amount <i>$<c:out value="${cancelItem.totalPrice}"/></i> will be refunded back to the credit
		card account that was used to make the purchase. <br>
		<br>
